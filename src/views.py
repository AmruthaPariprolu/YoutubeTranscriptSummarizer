...
def get_transcript_long(request):
    if request.method == 'POST':
        ...
        try:
            ...
            return render(request, 'transcript.html', {'transcript':transcript_text,'len_transcript':len(transcript_text),'summary': final_summary, 'len_summary':len(final_summary)})
